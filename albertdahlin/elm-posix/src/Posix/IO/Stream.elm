...
import Posix.Internal.Stream as Internal
...
read (Internal.Stream pipe _ decoder) =
    IO.callJs "readStream"
        ...
        (Posix.Internal.Js.decodeJsResultString (Decode.nullable decoder))
...
read_ (Internal.Stream pipe _ decoder) =
    IO.callJs "readStream"
        ...
        (Posix.Internal.Js.decodeJsResult (Decode.nullable decoder))
        |> IO.andThen IO.fromResult
        |> IO.mapError
            (\err ->
                case err.code of
